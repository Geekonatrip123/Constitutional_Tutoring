...
RESPONSE:"""
    ...
    def _parse_response(self, response_text: str) -> Dict[str, Any]:
        """Parse the LLM's JSON response - handles extra text after JSON."""
        ...
        try:
            # Use JSONDecoder to parse just the first JSON object
            import json.decoder
            ...
            # Decode from that position (stops at first complete object)
...
if __name__ == "__main__":
    ...
    planner = ControlPlanner(
        ...
        alignment_scorer_path="C:/Users/shlok/Research/models/alignment_scorer/alignment_scorer.pkl"
    )
